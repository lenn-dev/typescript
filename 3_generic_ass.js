...
console.log(last(a_));
console.log(last(b_));
var prepend = function (items, item) { return __spreadArray([item], items, true); };
var items = [1, 2, 3, 4, 5];
var newItems = prepend(items, 0);
console.log(newItems);
var mix = function (arr, arr1) { return __spreadArray(__spreadArray([], arr, true), arr1, true); };
var arr = [1, 2, 3];
var arr1 = [4, 5, 6];
var mixedArr = mix(arr, arr1);
...
var found1 = findIndex(arr3, 3);
var found2 = findIndex(arr3, 7);
console.log(found1);
console.log(found2);
var slice = function (arr, b, c) {
    if (c)
        return arr.slice(b, c);
    return arr.slice(b);
};
var arr4 = ["a", "b", "a", "na", "n", "a", "h", "f"];
